...
{
    public function test_handle_returns_failure_contract_when_model_resource_is_null(): void
    {
    ...
    public function test_handle_returns_failure_contract_when_model_resource_is_omitted(): void
    {
        $action = new DetailResponseAction;
    ...
    public function test_handle_returns_success_contract_with_array_data_when_model_resource_is_found(): void
    {
        $action = new DetailResponseAction;
    ...
    public function test_handle_returns_success_contract_with_json_resource_data_when_model_resource_is_found(): void
    {
        $action = new DetailResponseAction;
